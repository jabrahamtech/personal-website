...
summary: "Some product decisions belong to the model. Others belong to boring UI. A practical guide to when to use the LLM, when to use a button, and why voice AI makes the trade-off obvious."
posted: 2026-05-12
...
image:
  src: "/posts/when-to-force-the-llm-and-when-to-use-a-button/hero.jpg"
...
<Figure
  src="/posts/when-to-force-the-llm-and-when-to-use-a-button/stat-500ms.jpg"
...
<Figure
  src="/posts/when-to-force-the-llm-and-when-to-use-a-button/architecture.jpg"
...
<Figure
  src="/posts/when-to-force-the-llm-and-when-to-use-a-button/pull-quote.jpg"
...
- [Most "human-in-the-loop" is escalation done badly](/posts/most-hitl-is-escalation-done-badly) — once you've decided the model owns a step, this is the next question: on what trigger a human gets pulled back in.
- [What Polymarket taught me about event-driven](/posts/polymarket-bot-event-driven) — the same line drawn on the back end, which work gets to be loose and event-driven and which has to be synchronous and deliberate.
