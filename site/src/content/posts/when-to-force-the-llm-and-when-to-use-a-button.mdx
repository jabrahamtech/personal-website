...
Related, but a different angle. That argument is about the *back-end* parts of an agent that should stay deterministic: rules, queues, database constraints, retries. This one is about the *front-end*: what the user clicks, sees, and steers with.
