...
{/* TODO before flipping draft → false:
  1) Footnote [1] needs primary citation. The 73% → 61.7% finding is well-cited in
     secondary sources (EDPS TechDispatch 2/2025); the primary paper is likely
     Goh et al. 2023/2024 in JAMA Internal Medicine or JAMA Network Open, but
     that has NOT been verified against the original journal record. Replace
     the placeholder in the Footnotes section before publishing.
  2) Source links are referenced narratively but not hyperlinked. Add inline
     citations / footnote links for: Vaccaro et al. 2024 (Nature Human Behaviour),
     Sele & Chugunova 2024 (PLOS One), Bainbridge 1983 (Ironies of Automation),
     EU AI Act Article 14, GDPR Article 22, EDPS TechDispatch 2/2025, Anthropic's
     Claude Code autonomy data. Source URLs are in the local research file
     `Claude/Projects/Blog Post/research-hitl-vs-escalation.md` under "Sources".
  3) Forward-link the two unwritten posts when they ship (add them to the
...
<Figure
  src="/posts/most-hitl-is-escalation-done-badly/figure-01.svg"
...
<Figure
  src="/posts/most-hitl-is-escalation-done-badly/figure-02.svg"
...
[1] Specific paper for the 73 percent to 61.7 percent finding: 2023 randomised clinical study of 450 clinicians given diagnostic assistance from intentionally biased AI. Reported in multiple secondary sources including the European Data Protection Supervisor TechDispatch 2/2025 on Human Oversight of Automated Decision-Making. Full primary citation to be added when verified against the original journal record.
