...
- [Stop running one coding agent for everything](/posts/coding-agent-setup-may-2026) — escalation between two agents: when a Codex run goes wrong, stop it and hand the failure back to the planner rather than letting it retry.
