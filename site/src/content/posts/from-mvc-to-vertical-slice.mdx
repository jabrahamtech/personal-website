...
- [The boring infrastructure stack I'd actually pick for a startup](/posts/boring-infrastructure-stack-for-startups): the boring, debuggable stack that pairs with a navigable codebase.
- [Stop running one coding agent for everything](/posts/coding-agent-setup-may-2026): once the repo is navigable, hand a slice to a bounded specialist instead of overloading one agent with the whole stack.
