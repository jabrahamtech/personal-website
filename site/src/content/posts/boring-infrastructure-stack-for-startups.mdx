...
- [Why layered codebases punish humans and AI coding agents](/posts/from-mvc-to-vertical-slice) — the codebase counterpart: once the stack is boring, this is the shape that keeps the code boring too.
- [Why "judgement is the differentiator" advice fails before PMF](/posts/judgement-before-pmf) — the same pre-Series-B pragmatism, applied to product judgement instead of infrastructure.
