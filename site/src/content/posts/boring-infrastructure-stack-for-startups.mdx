...
- [Why layered codebases punish humans and AI coding agents](/posts/from-mvc-to-vertical-slice): once the stack is boring, this is the shape that keeps the code boring too.
